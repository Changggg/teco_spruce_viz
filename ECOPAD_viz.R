...
plot(days,gpp,type='l',axes=FALSE,xlab="Years",ylab="GPP")
...
plot(days,foliage,type='l',axes=FALSE,xlab="Years",ylab="Foliage")
axis(side=1,at=ticks,labels=xticklab)
axis(side=2)
...
plot(days,wood,type='l',axes=FALSE,xlab="Years",ylab="Wood")
axis(side=1,at=ticks,labels=xticklab)
axis(side=2)
...
plot(days,root,type='l',axes=FALSE,xlab="Years",ylab="Root")
axis(side=1,at=ticks,labels=xticklab)
axis(side=2)
...
plot(days,soil,type='l',axes=FALSE,xlab="Years",ylab="Soil C")
axis(side=1,at=ticks,labels=xticklab)
axis(side=2)
